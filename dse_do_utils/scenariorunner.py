...
class ScenarioRunner:
    """
    TODO: remove local_root, local_platform, replace by data_directory
    """
    def __init__(self,
                 scenario_db_manager: ScenarioDbManager,
                 optimization_engine_class,
                 data_manager_class,
                 scenario_db_manager_class,  # For the SQLite data check
        ...
        self.optimization_engine_class: Any = optimization_engine_class
        self.data_manager_class: Any = data_manager_class
        self.scenario_db_manager_class: Any = scenario_db_manager_class
        self.scenario_generator_class = scenario_generator_class

        self.optimization_engine: Any = None  # To be set in run.
        self.data_manager: Any = None  # To be set in run.
        self.sqlite_scenario_db_manager: Any = None  # To be set in run.
