# -*- coding: utf-8 -*-
#
# DSE DO Utils documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('./dummy_code')) #To get the dummy module `dd_scenario` in the path
sys.path.insert(0, os.path.abspath('../..')) #To get the package `dse_do_utils` on the path.
...
# language = None  # Deprecated from version 5.0
...
htmlhelp_basename = 'DSEDOUtilsdoc'
...
latex_documents = [
    (master_doc, 'DSEDOUtils.tex', u'DSE DO Utils Documentation',
     u'Victor Terpstra', 'manual'),
]
...
man_pages = [
    (master_doc, 'dsedoutils', u'DSE DO Utils Documentation',
     [author], 1)
]
